...
function AssessmentFormContent({ onClose }: { onClose: () => void }) {
  const { user } = useAuth()
...
export default function AssessmentForm({ assessment, onClose }: AssessmentFormProps) {
  return (
    <AssessmentProvider assessmentId={assessment?.id}>
      <AssessmentFormContent onClose={onClose} />
    </AssessmentProvider>
  )
}